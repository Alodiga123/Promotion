...
export class BannerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.bannerService
      ...
      .subscribe(
        (res: HttpResponse<IBanner[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInBanners(): void {
    this.eventSubscriber = this.eventManager.subscribe('bannerListModification', () => this.loadPage());
  }
