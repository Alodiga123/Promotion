...
export class CurrencyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.currencyService
      ...
      .subscribe(
        (res: HttpResponse<ICurrency[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICurrency[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
