...
export class CurrencyUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    description: [null, [Validators.required, Validators.minLength(5), Validators.maxLength(80)]],
    simbol: [null, [Validators.required]],
  });
  ...
  private createFromForm(): ICurrency {
    return {
      ...
      simbol: this.editForm.get(['simbol'])!.value,
    };
  }
